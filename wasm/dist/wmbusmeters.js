...
/** @type {function(string, boolean=, number=)} */
  ...
  instrumentWasmImports(imports) {
        var importPattern = /^(emscripten_sleep|usleep|invoke_.*|__asyncjs__.*)$/;
...
var ASM_CONSTS = {
  773408: ($0, $1, $2, $3, $4) => { if (typeof queueBaudrateChange === 'function') return queueBaudrateChange($0, $1, $2, $3, $4); return 0; },  
 773517: ($0) => { return (typeof serialPortReady !== 'undefined' && serialPortReady[$0]) ? 1 : 0; },  
 773601: ($0) => { serialPortReady[$0] = false; },  
 773634: ($0, $1, $2) => { writeSerial($0, $1, $2); },  
 773663: () => { return (typeof pendingDisconnects !== 'undefined') ? pendingDisconnects.length : 0; },  
 773751: ($0) => { return pendingDisconnects[$0]; },  
 773786: ($0) => { pendingDisconnects.splice(0, $0); },  
 773824: () => { return (typeof pendingConnects !== 'undefined') ? pendingConnects.length : 0; },  
 773906: ($0) => { return pendingConnects[$0]; },  
 773938: ($0) => { pendingConnects.splice(0, $0); },  
 773973: ($0) => { try { FS.createDevice('/dev', 'ttyWebUSB' + $0, function() { return null; }, function(c) {} ); } catch(e) { console.warn('[vfs] createDevice /dev/ttyWebUSB' + $0 + ' failed:', e); } },  
 774159: ($0) => { try { FS.unlink('/dev/ttyWebUSB' + $0); } catch(e) {} },  
 774217: ($0) => { if (typeof drainSerialData === 'function') drainSerialData($0); }
};
...
var _wm_serial_close = Module['_wm_serial_close'] = makeInvalidEarlyAccess('_wm_serial_close');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['wm_serial_close'] != 'undefined', 'missing Wasm export: wm_serial_close');
  ...
  assert(typeof wasmExports['dynCall_diiii'] != 'undefined', 'missing Wasm export: dynCall_diiii');
  assert(typeof wasmExports['dynCall_viiid'] != 'undefined', 'missing Wasm export: dynCall_viiid');
  assert(typeof wasmExports['dynCall_viiiid'] != 'undefined', 'missing Wasm export: dynCall_viiiid');
  ...
  _wm_serial_close = Module['_wm_serial_close'] = createExportWrapper('wm_serial_close', 1);
  ...
  dynCall_diiii = dynCalls['diiii'] = createExportWrapper('dynCall_diiii', 5);
  dynCall_viiid = dynCalls['viiid'] = createExportWrapper('dynCall_viiid', 5);
  dynCall_viiiid = dynCalls['viiiid'] = createExportWrapper('dynCall_viiiid', 6);
