...
$(BUILD)/fuzz_frames: $(PROG_OBJS) $(DRIVER_OBJS) $(BUILD)/fuzz_frames.o
	$(CXX) $(DEBUG_FLAGS) -o $(BUILD)/fuzz_frames $(PROG_OBJS) $(DRIVER_OBJS) $(BUILD)/fuzz_frames.o $(LDFLAGS) -lpthread
...
build_fuzz: afl_prepared
	...
	$(MAKE) AFL_HARDEN=1 CXX=$(AFL_HOME)/afl-g++-fast FUZZFLAGS=-DFUZZING=true $(BUILD)/fuzz_frames
...
run_fuzz_frames:
	${AFL_HOME}/afl-fuzz -i fuzz_testcases/frames -o fuzz_testcases/frames/findings build/fuzz_frames
