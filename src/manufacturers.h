...
X(BRT,MANFCODE('B','R','T'),"BEREKET TEKNOLOJIK OLCUM SISTEMLERI BIL ELK INS ITH IHR SAN VE TIC STI, Turkey")\
...
X(EKS,MANFCODE('E','K','S'),"DICLE KOK ENERJI YATIRIM")\
...
X(KLP,MANFCODE('K','L','P'),"test 5, Botswana")\
...
X(LGZ,MANFCODE('L','G','Z'),"Landis Gyr")\
...
X(PTR,MANFCODE('P','T','R'),"Pfiffner Transformator, Turkey")\
...
#define MANUFACTURER_KLP MANFCODE('K','L','P')
